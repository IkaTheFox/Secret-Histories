...
On the Setup page
* Select the [fa-solid fa-plug]Add-on Modules tab
* Click the [fa-solid fa-gear-code] cog button
* Set the Package Title this is the friendly name you use to find the module in the module list
* Select the [fa-solid fa-book-atlas]Compendium Packs tab
* Click the [fa-solid fa-plus]Add Compendium Pack button
* Set the Label to be human readable
* Set the Document Type to Item
* Set the Required System to Secret Histories
* Click the [fa-solid fa-gear-code]Create Module button

You can return to this page and edit the module to add more Compendium Packs later

Launch your world and enable the module in the [fa-solid fa-cogs]Game Settings [fa-solid fa-cube]Manage Modules
...
* Click [fa-solid fa-book-user]How to add to your compendium
* Make sure you have the correct era, language, and modules enabled in [fa-solid fa-cogs]Game Settings
* Select which Item types you want to include
* Click [fa-solid fa-check]Populate
* After a short while the compendium will be populated ready for you to edit

## Updating actors to use the updated items
If you do not have a scene active you must create a scene to use the scene controls

* Click [game-icon game-icon-tentacle-strike]Keeper's tools
* Click [fa-solid fa-fingerprint]CoC ID: Actor Item replacement
* Select the required options
* Click [fa-solid fa-check]Update
